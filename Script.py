class script(object):
    START_TXT = """ʜᴇʟᴏ {},
ᴍʏ ɴᴀᴍᴇ ɪꜱ <a href=https://t.me/{}>{}</a>, ɪ ᴀᴍ ᴊᴜꜱᴛ ᴀ ꜱɪᴍᴘʟᴇ ᴘʀᴇ-ꜰᴜᴄᴛɪᴏɴᴇᴅ ᴀᴜᴛᴏꜰɪʟᴛᴇʀ ʙᴏᴛ ⚡️
ɪᴛꜱ ᴇᴀꜱʏ ᴛᴏ ᴜꜱᴇ ᴍᴇ 😉. ᴊᴜꜱᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀꜱ ᴀᴅᴍɪɴ, ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇꜱ  ᴛʜᴇʀᴇ 🥳
"""
    HELP_TXT = """𝙷𝙴𝚈 {}
