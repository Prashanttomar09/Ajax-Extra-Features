class script(object):
    START_TXT = """ʜᴇʟʟᴏ {},
ᴍʏ ɴᴀᴍᴇ ɪs <a href=https://t.me/{}>{}</a>, ɪ ᴀᴍ ᴀɴ ᴇxᴛʀᴀ ᴏʀᴅɪɴᴀʀʏ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ sᴏᴍᴇ ᴘᴏᴡᴇʀs.ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴀᴅᴍɪɴ ɪ ᴡɪʟʟ sʜᴏᴡ ᴍʏ ᴘᴏᴡᴇʀs ᴛʜᴇɪʀ
"""
    HELP_TXT = """𝙷𝙴𝚈 {}
